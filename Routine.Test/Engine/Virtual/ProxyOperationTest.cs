...
namespace Routine.Test.Engine.Virtual
{
	...
	public class ProxyOperationTest : CoreTestBase
	{
		...
		public void Proxy_operations_inherit_ispublic__name__parameters__return_type_and_custom_attributes_from_given_operation()
		{
			...
			IOperation proxy = new ProxyOperation(type.of<string>(), real);
		...
		public void Parent_type_is_what_is_given_as_parent_type()
		{
			...
			IOperation real = type.of<string>().GetMethod("Insert");
			IOperation proxy = new ProxyOperation(expected, real);
		...
		{
			IOperation real = type.of<string>().GetMethod("Insert");
			IOperation proxy = new ProxyOperation(type.of<char>(), real, (o, p) => o.ToString());
		...
		public void Additional_parameter_shifts_index_of_the_real_parameters()
		{
			...
			IOperation real = type.of<string>().GetMethod("Insert");
			IOperation proxy = new ProxyOperation(type.of<char>(), real, (o, p) => o.ToString(), parameterMock.Object);
		...
		public void Target_can_be_obtained_from_an_additional_parameter()
		{
			...
			IOperation real = type.of<string>().GetMethod("Insert");
			IOperation proxy = new ProxyOperation(type.of<char>(), real, (o, p) => p[0], parameterMock.Object);
