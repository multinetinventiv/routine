...
namespace Routine.Core.Rest
{
	...
	{
		public static ContextBuilder UsingSerializer(this ContextBuilder source, int maxJsonLength) { return source.UsingSerializer(new JavaScriptSerializerAdapter(new JavaScriptSerializer { MaxJsonLength = maxJsonLength })); }
		public static ContextBuilder UsingSerializer(this ContextBuilder source, int maxJsonLength, int recursionLimit) { return source.UsingSerializer(new JavaScriptSerializerAdapter(new JavaScriptSerializer { MaxJsonLength = maxJsonLength, RecursionLimit = recursionLimit })); }
	}
}