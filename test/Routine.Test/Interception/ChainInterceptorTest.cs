...
using TestContext = Routine.Test.Interception.Stubs.TestContext;
...
namespace Routine.Test.Interception
{
        ...
        where TInvocation : IInvocation, new()
    {
        ...
        {
            var interceptor = new ChainInterceptor<TestContext>();

            interceptor.Add(BuildRoutine.Interceptor<TestContext>().Do()
        ...
        {
            var interceptor1 = new ChainInterceptor<TestContext>();
            interceptor1.Add(BuildRoutine.Interceptor<TestContext>().Before(ctx => ctx.Value += " - before1"));
            interceptor1.Add(BuildRoutine.Interceptor<TestContext>().Before(ctx => ctx.Value += " - before2"));

            var interceptor2 = new ChainInterceptor<TestContext>();
            interceptor2.Add(BuildRoutine.Interceptor<TestContext>().Before(ctx => ctx.Value += " - before3"));
            interceptor2.Add(BuildRoutine.Interceptor<TestContext>().Before(ctx => ctx.Value += " - before4"));
        ...
        public void After_merging_two_chains__new_interceptor_is_added_to_the_very_last_chain_link()
        {
            ...
            interceptor1.Add(BuildRoutine.Interceptor<TestContext>().Before(ctx => ctx.Value += " - before5"));
        ...
        public void When_an_empty_chain_is_merged_with_a_chain__given_chain_s_links_added_to_the_empty_one()
        {
            ...
            var interceptor2 = new ChainInterceptor<TestContext>();
            interceptor2.Add(BuildRoutine.Interceptor<TestContext>().Before(ctx => ctx.Value += " - before1"));
            interceptor2.Add(BuildRoutine.Interceptor<TestContext>().Before(ctx => ctx.Value += " - before2"));
        ...
        {
            var testing = new ChainInterceptor<TestContext>();
