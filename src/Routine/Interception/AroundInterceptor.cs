    ...
    where TContext : InterceptionContext
{
    ...
    public AroundInterceptor<TContext> Before(Func<TContext, Task> beforeDelegate) { this.beforeDelegate = beforeDelegate ?? this.beforeDelegate; return this; }
    ...
    public AroundInterceptor<TContext> Success(Func<TContext, Task> successDelegate) { this.successDelegate = successDelegate ?? this.successDelegate; return this; }
    ...
    public AroundInterceptor<TContext> Fail(Func<TContext, Task> failDelegate) { this.failDelegate = failDelegate ?? this.failDelegate; return this; }
    ...
    public AroundInterceptor<TContext> After(Func<TContext, Task> afterDelegate) { this.afterDelegate = afterDelegate ?? this.afterDelegate; return this; }
