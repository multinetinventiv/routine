...
{
    public ConventionBasedCodingStyle FromBasic() => new ConventionBasedCodingStyle()
        ...
        .Module.Set(c => c
            ...
            .When(t => t is TypeInfo ti && ti.IsValueType && ti.IsGenericType &&
                       ti.GetActualType().GetGenericTypeDefinition() == typeof(Nullable<>)))
        .TypeName.Set(c => c
